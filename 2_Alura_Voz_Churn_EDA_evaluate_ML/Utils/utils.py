...
#===========================================================================
def plot_countplot(data_db, x, titulo, label_x: str, figsize: tuple = (5, 3), hue=None, small: bool = False):
    plt.figure(figsize=figsize)
    custom_params = {"axes.spines.right": False, "axes.spines.top": False,
                     "axes.spines.left": False, "axes.spines.bottom": False}

    sns.set_theme(style="ticks", rc=custom_params)
    ax = sns.countplot(x=x, hue=hue, data=data_db, palette='viridis')
    ...
    plt.show()
#===========================================================================
def heatmap_corr(df, figsize: tuple = (5, 3)):
    corr = df.corr()
    plt.figure(figsize=figsize)
    sns.heatmap(corr,
                ...
                cmap='viridis')
#===========================================================================
def plot_matrix_confusion(y_true_teste, y_pred_teste, group_names=None,
...
#===========================================================================
def compare_models_metrics(metrica, nomes_modelos, y_true_treino, y_pred_treinos, y_true_teste, y_pred_testes):
    """
